...
@section('title', 'Daftar Kategori Kalender')
@section('extra-css')
    ...
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Category Calendar</li>
            </ol>
        </div>
    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" align="center">
                                        <button type="button" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#edit-{{$d->ID_CATEGORY_CALENDAR}}">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="basic-form">
                <form action="{{url('admin/tambah-kategori-kalender')}}" method="POST">
                @csrf
...
<div class="modal fade show" id="edit-{{$d->ID_CATEGORY_CALENDAR}}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="basic-form">
                <form action="{{url('admin/edit-kategori-kalender')}}" method="POST">
                @csrf
                    <input type="hidden" name="id" value="{{$d->ID_CATEGORY_CALENDAR}}">
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Nama Kategori</label>
                            <input type="text" name="nama" value="{{$d->NAMA}}" class="form-control input-default" placeholder="Nama Kategori" required>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-dismiss="modal">Batal</button>
